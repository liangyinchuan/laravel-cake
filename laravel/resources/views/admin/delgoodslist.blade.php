...
<form method="get" action="/admin/delgoods" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 已下架商品列表</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    ...
    <table class="table table-hover text-center">
      ...
      <tr>
            ...
            <td>{{ ($v->status==2?"已下架":"") }}</td>
            <td>
                <div class="button-group">
                    <a class="button border-main" href="/admin/delgoods/{{ $v->id }}/edit">
