        ...
        <div class="man">
            ...
            <div class="rght">
                ...
                <div class="col-md-10 col-sm-10">
                    <div data-react-class="Pays" data-react-props="">
                        <div class="v2-orders-collection-container" data-reactid=".0">
                            <div class="row current-orders-container" data-reactid=".0.0">
                                <div class="col-xs-12 col-md-12 col-sm-12 info-title" data-reactid=".0.0.1">
                                    订单信息
                                </div>
                                ...
                                <div class="clo-xs-12 col-md-12 col-sm-12" data-reactid=".0.0.2">
                                    ...
                                    <div class="row order-product-list" data-reactid=".0.0.2.0">
                                        ...
                                        <div style="margin-top:25px;" class="col-md-4 col-sm-4 col-xs-5" data-reactid=".0.0.2.0.0">
                                            <img class="product-image" src='{{ asset("/images/goods/$v->goodspics") }}' alt="{{ $v->goodsname }}" >
                                        </div>
                                ...
                                <div class="col-xs-12 col-md-12 col-sm-12 order-details" data-reactid=".0.0.4">
                                    <div class="order-text" data-reactid=".0.0.4.0">
                                        支付方式: {{ $v->paytype==1?'支付宝':($v->paytype==2?'微信':"货到付款") }}
                                    </div>
                                ...
                                <div class="col-xs-12 col-md-12 col-sm-12 tally-orders-desktop" data-reactid=".0.0.6">
                                    ...
                                    <a href="/home/qcode/{{ $v->total }}" class="submit-button " style="background-color:#9C1E2E;dispaly:block;width:500px;">去付款</a>
                                    </div>
                                </div>
